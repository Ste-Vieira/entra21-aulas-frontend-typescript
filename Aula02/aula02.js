...
let animal1 = new Animal("drodofila", "mosca", 0.5, ["ar", "lixo", "comida"]);
console.log(animal1);
...
console.log(animal1.getEspecie);
console.log("===================================");
let animal2 = new Animal("Felis silvestris catus", "gato", 3.4, ["cama", "sofá"]);
console.log(animal2);
...
console.log(animal2.getEspecie);
console.log("=========================");
let stephanie = new Aluno("Stephanie", 28, [8, 9, 7.8]);
...
let fulano = new Aluno("Jorge", 44, [7, 3.4, 6.7]);
console.log(fulano);
...
console.log("========================");
let professor1 = new Professor("Marta", 48, ["Matématica", "Estatistica", "Lógica"], 80, 12);
...
console.log("===========================");
let vendedor1 = new Vendedor("Luciano", 31, 15, 8000);
